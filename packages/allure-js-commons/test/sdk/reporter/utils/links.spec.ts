...
import type { LinkTemplates } from "../../../../src/sdk/reporter/types.js";
...
describe("formatLinks", () => {
  ...
  describe("with the URL-only default link pattern", () => {
    const patterns: LinkTemplates = { [LinkType.DEFAULT]: { urlTemplate: "https://qux/%s" } };
